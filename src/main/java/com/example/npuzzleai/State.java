...
public class State {
    ...
    public int estimate(State goalState) {
        ...
        else if (heuristic == 3) est = heuristic4(goalState);
        else if (heuristic == 4) est = heuristic5(goalState);
    ...
    // Heuristic 3 - Tổng số ô sai hàng và số ô sai cột
    ...
    // Heuristic  4- Tổng khoảng cách để đưa các ô về đúng vị trí + số ô xung đột tuyến tính
